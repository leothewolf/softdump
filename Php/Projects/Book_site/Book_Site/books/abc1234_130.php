              ...
              <?php 
                ...
                $targetuser ="abc1234";
                    ...
                    $reporttragetlink="books/".$targetuser."_".$targetid.".php";
                            ...
                            if($stmt){
                              ...
                              if(mysqli_stmt_execute($stmt)){   
                                header("location: ../report.php?link=".$reporttragetlink);            
                              }
              ...
              <html lang="en">
                    <head>
                      ...
                      <title>Does Consistency Lead to Success?  | abc1234 | Booksite</title>

...
<body style="background: linear-gradient(rgba(255,255,255,.5), rgba(255,255,255,.5)), url('../img/bg.jpg')">
    ...
    // $query1="SELECT * FROM bookmark WHERE username = '$username'";
    // $result = mysqli_query($conn,$query1);
    // if(mysqli_num_rows($result) > 0){
    //   echo '<h2 style="margin-top: 10px;margin-left: 10px;">Book Marks</h2>';
    // }
    ...
    <!-- <div class="storynava">
                    <div class="storynavd">
                        ...
                        <div class="storyinfob">
                            ...
                            <hr>
                            <div class="stdesc"></div>
                        </div>
                    </div>
                    <div class="bdbtn">
                      <a href="../user_action/unbookmark.php?tusername=".$username."&id=".$r_id.><button class="delbtn">Remove</button></a>
                    </div>
                </div> -->
    <?php 
        ...
        while($Row=mysqli_fetch_array($Table)){
            $r_id = $Row["id"];
            $query1="SELECT * FROM books WHERE id = '$r_id'";
            ...
            echo '
                <div class="storynava" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                    <div class="storynavd">
                        <img src="../img/book.png" alt="">
                        <div class="storyinfob">
                            <div class="title"><a href="../books/'.$Row1["username"].'_'.$Row1["id"].'.php">'. $Row1["title"] .'</a></div>
                            <hr>
                            <div class="stdesc">'. $Row1["description"] .'</div>
                        </div>
                    </div>
                    <div class="bdbtn">
                      <a href="unbookmark.php?tusername='.$username.'&id='.$r_id.'"><button class="delbtn">Remove</button></a>
                    </div>
                </div>';
        }
    ?>
    ...
    <?php 
      ...
      if(mysqli_num_rows($result) == 0){
        ...
        <br/> No Books Bookmarked Yet <br/> <button class="pab"><a href="../">Read Books</a></button></div>';
      }

...
<head>
    ...
    <meta name="viewport" content="width=1142, height=640, initial-scale=1.0">
    <title>Random Question Generator</title>
    <link rel="shortcut icon" href="https://images-na.ssl-images-amazon.com/images/I/41W2Ueh0D7L.png" type="image/png">
    <link rel="stylesheet" href="styles.css">
</head>
<body>
<h3>Random Question Generator</h3>
<form action="index.php" method="post">
You wish to generate a random question?
<br>
<br>
<input type="text" name="yesorno">
<br>
<br>
<input type="submit">
<br>
...
$yesorno=strtolower($yesorno);

$random_number=rand(0,588);
...
"If you were moving to another country, but could only pack one carryon sized bag, what would you pack?",
...
"If you could have an allexpenses paid trip to see any famous world monument, which monument would you choose?",
...
"What would be the clickbait titles of some popular movies?",
...
"What would the adult version of an icecream truck sell and what song would it play?",
...
"What’s legal now, but probably won’t be in  years?",
...
"What happens regularly that would horrify a person from  years ago?",
...
"What questions would you like to ask a time traveler from  years in the future?",
...
"What do you think you do better than % of people?",
...
"How often do you curse? And what’s your goto string of curse words?",
...
"What book has changed one of your longheld opinions?",
...
"Where is the most aweinspiring place you have been?",
...
"Does technology simplify life or makes us lazy?",
...
"What holidays have been overcommercialized?",
...
"If you could call up anyone in the world and have a onehour conversation, who would you call?",
...
switch ($yesorno) {
    case "yes":
        echo "Random question: " . $random_questions[$random_number];
    break;
    case "no":
        echo "You typed no meaning you don't want a random question displayed";
    break;
    default: echo "Invalid input!!"."<br>"."(Type yes to display random question or no to not display any)";
}
